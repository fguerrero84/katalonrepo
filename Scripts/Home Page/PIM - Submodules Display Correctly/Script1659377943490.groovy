...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/b_PIM'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/a_Reports'), 0)
